...
class ToponymData(BaseModel):
    ...
    toponym: str  # Add a field for the toponym name
...
if __name__ == "__main__":
    data_directory = "data"
    file_name = "GeoCoDe_test.xml"
    processed_articles = process_articles(data_directory, file_name)

    with open("processed_GeoCoDe_test.json", "w", encoding="utf-8") as f:
        json.dump([article.model_dump() for article in processed_articles], f, ensure_ascii=False, indent=4)
