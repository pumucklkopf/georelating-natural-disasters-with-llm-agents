...
class CandidateGenerationState(CandidateGenerationOutput):
    ...
    article_text: str = Field(description="The text of the article",
                              default="")
    initial_prompt: PipelinePromptTemplate | str = Field(description="The prompt used to generate the output",
                                                         default=None)
    ...
    critic_prompt: PromptTemplate = Field(description="The prompt used to generate the critic output",
                                          default=None)
    critic_feedback: AIMessage = Field(description="The output (feedback) generated by the critic",
                                       default=None)
    reflected_prompt: PromptTemplate = Field(
